  ...
  function($routeProvider) {
    $routeProvider.
      ...
      when('/Electioncandidates', {
       ...
       when('/Pwise', {
        templateUrl: 'pages/pwise.html',
        controller: 'pwisepages'
      }). 
        when('/Cwise', {
        templateUrl: 'pages/cwise.html',
        controller: 'ecandidatescontroller'
      }).  
        when('/CwiseT', {
        templateUrl: 'pages/cwiset.html',
        controller: 'cwisetpages'
      }).
...
sampleApp.controller('pwisepages', function($scope) {
     $scope.message = 'This is pwise pages';});


sampleApp.controller('cwisepages', function($scope) 
{
     $scope.message1 = 'This is cwise pages';


   });


sampleApp.controller('cwisetpages', function($scope) {
     $scope.message2 = 'This is cwiset pages';
